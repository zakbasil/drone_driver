...
// PID coefficients
float Kp[3] = {3, 3, 3 };    // P coefficients in that order : Yaw, Pitch, Roll
float Ki[3] = {0.1, 0.1, 0.1 }; // I coefficients in that order : Yaw, Pitch, Roll
float Kd[3] = {0, 2, 2 };        // D coefficients in that order : Yaw, Pitch, Roll
// ---------------------------------------------------------------------------
/**
