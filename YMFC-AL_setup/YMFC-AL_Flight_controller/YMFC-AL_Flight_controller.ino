...
void loop(){
    ...
    if (Serial.available() >= 12) { // Wait until 12 bytes (3 floats) are available
    // Read the 3 floating-point numbers from the Serial Monitor
    pid_p_gain_roll = Serial.parseFloat();
    pid_i_gain_roll = Serial.parseFloat();
    pid_d_gain_roll = Serial.parseFloat();
